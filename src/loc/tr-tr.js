define([], () => {
  return {
    ...
    "DatePickerDayShortSunday": "Paz",
    "DatePickerDayLongMonday": "Pazartesi",
    "DatePickerDayShortMonday": "Pzt",
    ...
    "DatePickerDayShortFriday": "Cum",
    "DatePickerDayLongSaturday": "Cumartesi",
    "DatePickerDayShortSaturday": "Cmt",
    ...
    "TermPickerMenuTerm": "Terim Menüsü",
    ...
    "DateTime": {
      ...
      "L_RelativeDateTime_XMinutesFuture": "{0} dakika içinde||{0} dakika içinde",
      ...
      "L_RelativeDateTime_XDaysFuture": "{0} gün içinde||{0} gün içinde",
    ...
    "CloseButton": "Kapatmak",
    "MonacoEditorOpenButtonLabel": "Açık düzenleyici",
    "MonacoEditorCancelButtonLabel": "İptal",
    "MonacoEditorSaveButtonLabel": "Kurtarmak",
    "MonacoEditorPanelTitle": "Şablonu Düzenle",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "Renk seçici, {0} seçildi.",
      "hex": "Hex",
      "red": "Kırmızı",
      "green": "Yeşil",
      "blue": "Mavi",
      ...
      "alphaAriaLabel": "Alfa",
      "transparencyAriaLabel": "Şeffaflık",
      "hueAriaLabel": "Ton",
      "svAriaLabel": "Doygunluk ve parlaklık",
      "svAriaValueFormat": "Doygunluk {0} parlaklık {1}",
      "svAriaDescription": "Doygunluğu ayarlamak için sol ve sağ okları kullanın. Parlaklığı ayarlamak için yukarı ve aşağı okları kullanın.",
      "hexError": "Altıgen değerler 3 ila 6 karakter uzunluğunda olmalıdır",
      "alphaError": "Alfa 0 ile 100 arasında olmalıdır",
      "transparencyError": "Şeffaflık 0 ile 100 arasında olmalıdır",
      "redError": "Kırmızı 0 ile 255 arasında olmalıdır",
      "greenError": "Yeşil 0 ile 255 arasında olmalıdır",
      "blueError": "Mavi 0 ile 255 arasında olmalıdır"
    },
    "gridControlColumn1Label": "Başlık",
    "gridControlColumn2Label": "Açıklama"
  };
});
