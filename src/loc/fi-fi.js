define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Muokkaa ominaisuuksia",
    "EditPropertiesPanelHeaderText": "Muokkaa raakaominaisuuksia",
    ...
    "DatePickerMonthShortMarch": "Turmella",
    ...
    "DatePickerDayShortSunday": "Aurinko",
    ...
    "TermPickerMenuTerm": "Termin valikko",
    ...
    "DeleteSelectedFileButtonLabel": "Poista valittu tiedosto",
    ...
    "CloseButton": "Sulkea",
    "MonacoEditorOpenButtonLabel": "Avaa editori",
    "MonacoEditorCancelButtonLabel": "Perua",
    "MonacoEditorSaveButtonLabel": "Säästää",
    "MonacoEditorPanelTitle": "Muokkaa mallia",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} värinvalitsin on valittuna.",
      "hex": "Kuudes painos",
      "red": "punainen",
      "green": "vihreä",
      "blue": "Täyttää",
      ...
      "alphaAriaLabel": "Alfa",
      "transparencyAriaLabel": "Läpinäkyvyys",
      "hueAriaLabel": "Liubov",
      "svAriaLabel": "Kylläisyys ja kirkkaus",
      "svAriaValueFormat": "{1} kylläisyys {0} kirkkaus",
      "svAriaDescription": "Käytä vasenta ja oikeaa nuolipainiketta kylläisyyden säätämiseen. Käytä ylä- ja alanuolia säätääksesi kirkkautta.",
      "hexError": "kuusikulmaisten arvojen on oltava 3–6 merkkiä pitkiä",
      "alphaError": "Alfan on oltava välillä 0 ja 100",
      "transparencyError": "Liukumäen on oltava välillä 0 ja 100",
      "redError": "Punaisen tulisi olla välillä 0 - 255",
      "greenError": "Vihreän on oltava välillä 0-255",
      "blueError": "Sinisen tulisi olla välillä 0 - 255"
    }
  };
});