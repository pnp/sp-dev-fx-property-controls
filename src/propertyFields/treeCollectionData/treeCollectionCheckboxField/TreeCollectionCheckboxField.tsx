...
export const TreeCollectionCheckboxField: React.FunctionComponent<ICollectionCheckboxFieldProps> = ({
  field,
  item,
  disableEdit,
  fOnValueChange,
  ...
  return <Checkbox checked={item[field.id] ? item[field.id] : false}
    ...
    className={`PropertyFieldTreeCollectionData__panel__boolean-field ${errorMessage ? styles.invalidField : ''}`} />;
};
