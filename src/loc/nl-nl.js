define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Eigenschappen bewerken",
    "EditPropertiesPanelHeaderText": "Bewerk onbewerkte eigenschappen",
    ...
    "TermPickerMenuTerm": "Menu voor termijn",
    ...
    "DeleteSelectedButtonTitle": "Geselecteerd bestand verwijderen",
    ...
    "SelectedLabel": "Uitverkoren",
    "SelectIcon": "Pictogram selecteren",
    "CloseButton": "Sluiten",
    "MonacoEditorOpenButtonLabel": "Open editor",
    "MonacoEditorCancelButtonLabel": "Annuleren",
    "MonacoEditorSaveButtonLabel": "Redden",
    "MonacoEditorPanelTitle": "Sjabloon bewerken",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} afdelingen worden geselecteerd.",
      "hex": "6e ed.",
      "red": "rood",
      "green": "groen",
      "blue": "Hoe in te vullen",
      "alpha": "Alfa",
      "transparency": "Caurredzamība",
      "alphaAriaLabel": "Alfa",
      "transparencyAriaLabel": "Caurredzamība",
      "hueAriaLabel": "Ljoebova's",
      "svAriaLabel": "Verzadiging en helderheid",
      "svAriaValueFormat": "{1} verzadiging {0} helderheid",
      "svAriaDescription": "Gebruik de linker- en rechterpijl om de verzadiging aan te passen. Als u de helderheid wilt aanpassen, gebruikt u de pijl-omhoog en pijl-omlaag.",
      "hexError": "zeshoekige waarden moeten tussen 3 en 6 tekens liggen",
      "alphaError": "alfa moet van 0 tot 100 zijn",
      "transparencyError": "Dia's moeten van 0 tot 100 zijn",
      "redError": "Rood moet van 0 tot 255 zijn",
      "greenError": "Groen moet van 0 tot 255 zijn",
      "blueError": "Blauw moet van 0 tot 255 zijn"
    }
  };
});