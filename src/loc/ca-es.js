define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Editeu les propietats",
    "EditPropertiesPanelHeaderText": "Editeu les propietats en brut",
    ...
    "TermPickerMenuTerm": "Menú per Trimestre",
    ...
    "DeleteSelectedButtonTitle": "Suprimeix el fitxer seleccionat",
    ...
    "SelectIcon": "Icona Selecciona",
    "CloseButton": "Tancar",
    "MonacoEditorOpenButtonLabel": "Editor obert",
    "MonacoEditorCancelButtonLabel": "Cancel·lar",
    "MonacoEditorSaveButtonLabel": "Salvar",
    "MonacoEditorPanelTitle": "Edita la plantilla",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "Selecció de color {0} seleccionat.",
      "hex": "Sisena edició",
      "red": "vermell",
      "green": "verd",
      "blue": "Fill",
      ...
      "alphaAriaLabel": "Alfa",
      "transparencyAriaLabel": "transparència",
      "hueAriaLabel": "Lyubov",
      "svAriaLabel": "Saturació i brillantor",
      "svAriaValueFormat": "Saturació {0} brillantor {1}",
      "svAriaDescription": "Utilitzeu les tecles de fletxa esquerra i dreta per ajustar la saturació. Utilitzeu les tecles de fletxa amunt i avall per ajustar la brillantor.",
      "hexError": "Els valors hexagonals han de tenir entre 3 i 6 caràcters",
      "alphaError": "Alfa ha d'estar entre 0 i 100",
      "transparencyError": "La transparència ha d'estar entre 0 i 100",
      "redError": "El vermell ha d'estar entre 0 i 255",
      "greenError": "El verd ha d'estar entre 0 i 255",
      "blueError": "El blau ha d'estar entre 0 i 255"
    }
  };
});