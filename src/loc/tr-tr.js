define([], () => {
  return {
    ...
    "DeleteSelectedButtonTitle": "Seçilen dosyayı sil",    
    ...
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} departmanı.",
      "hex": "6f ed.",
      "red": "Kırmızı",
      "green": "kereviz",
      "blue": "Nasıl bitirilir",
      "alpha": "Arjantin",
      "transparency": "Kaurredzamiba",
      "alphaAriaLabel": "Arjantin",
      "transparencyAriaLabel": "Kaurredzamiba",
      "hueAriaLabel": "Arjantin",
      "svAriaLabel": "Doygunluk ve parlaklık",
      "svAriaValueFormat": "Parlaklık {1} {0} doygunluk",
      ...
      "transparencyError": "Resim sayısı 0 ile 100 arasında olmalıdır",
