define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Upraviť vlastnosti",
    "EditPropertiesPanelHeaderText": "Upravte nespracované vlastnosti",
    ...
    "TermPickerMenuTerm": "Menu pre termín",
    ...
    "DeleteSelectedFileButtonLabel": "Zmazať vybraný súbor",    
    ...
    "SelectedLabel": "Vybraný",
    "SelectIcon": "Ikona Vybrať",
    "CloseButton": "Zavrieť",
    "MonacoEditorOpenButtonLabel": "Otvoriť editor",
    "MonacoEditorCancelButtonLabel": "Zrušiť",
    "MonacoEditorSaveButtonLabel": "Zachrániť",
    "MonacoEditorPanelTitle": "Upraviť šablónu",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} oddelenia.",
      "hex": "6f vyd.",
      "red": "červený",
      "green": "zelený",
      "blue": "Ako dokončiť",
      ...
      "svAriaLabel": "Sýtosť a jas",
      "svAriaValueFormat": "Sýtosť {1} {0} jas",
      "svAriaDescription": "Pomocou šípok doľava a doprava upravte sýtosť. Ak chcete upraviť jas, použite šípky nahor a nadol.",
      "hexError": "Šesťuholníkové hodnoty musia mať dĺžku od 3 do 6 znakov",
      "alphaError": "alfa musí byť medzi 0 a 100",
      "transparencyError": "Počet diapozitívov by mal byť od 0 do 100",
      "redError": "Červená by mala byť medzi 0 a 255",
      "greenError": "Zelená by mala byť medzi 0 a 255",
      "blueError": "Modrá musí byť medzi 0 a 255"
    }
  };
});