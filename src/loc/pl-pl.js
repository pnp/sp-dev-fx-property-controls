define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Edytuj właściwości",
    "EditPropertiesPanelHeaderText": "Edytuj surowe właściwości",
    ...
    "DateFormat": "MM/DD/RRRR gg:mm A",
    "DeleteSelectedFileButtonLabel": "Usuń wybrany plik",    
    ...
    "CloseButton": "Zamykać",
    "MonacoEditorOpenButtonLabel": "Otwórz edytor",
    "MonacoEditorCancelButtonLabel": "Anuluj",
    "MonacoEditorSaveButtonLabel": "Zapisać",
    "MonacoEditorPanelTitle": "Edytuj szablon",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "Wybierane są {0} działy.",
      "hex": "6e wyd.",
      "red": "czerwony",
      "green": "zielony",
      "blue": "Jak wypełnić",
      ...
      "svAriaLabel": "Nasycenie i jasność",
      "svAriaValueFormat": "{1} nasycenie {0} jasność",
      "svAriaDescription": "Użyj strzałek w lewo i w prawo, aby dostosować nasycenie. Aby dostosować jasność, użyj strzałek w górę i w dół.",
      "hexError": "Wartości sześciokątne muszą zawierać od 3 do 6 znaków",
      "alphaError": "alfa powinna wynosić od 0 do 100",
      "transparencyError": "Slajdy muszą zawierać się w przedziale od 0 do 100",
      "redError": "Czerwony powinien wynosić od 0 do 255",
      "greenError": "Zielony powinien wynosić od 0 do 255",
      "blueError": "Niebieski powinien wynosić od 0 do 255"
    }
  };
});