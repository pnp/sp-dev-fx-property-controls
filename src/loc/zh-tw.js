define([], () => {
  ...
  "EditPropertiesButtonLabel": "編輯屬性",
  "EditPropertiesPanelHeaderText": "編輯原始屬性",
  "SaveButtonLabel": "救。",
  ...
  "DeleteSelectedFileButtonLabel": "刪除所選擇的文件",  
  ...
  "SelectIcon": "選擇圖示",
  "CloseButton": "關閉",
  "MonacoEditorOpenButtonLabel": "打開編輯器",
  "MonacoEditorCancelButtonLabel": "取消",
  "MonacoEditorSaveButtonLabel": "救",
  "MonacoEditorPanelTitle": "編輯範本",
  "ColorPickerStrings": {
    "rootAriaLabelFormat": "{0}部門。",
    "hex": "6f 編輯。",
    "red": "紅色",
    "green": "芹菜",
    "blue": "如何完成",
    ...
    "transparency": "考雷扎米巴",
    "alphaAriaLabel": "阿根廷",
    "transparencyAriaLabel": "考雷扎米巴",
    "hueAriaLabel": "阿根廷",
    "svAriaLabel": "飽和度和亮度",
    "svAriaValueFormat": "亮度{1} {0}飽和度",
    "svAriaDescription": "使用左右箭頭來調節飽和度。 使用上下箭頭調整亮度。",
    "hexError": "六邊形值必須長 3 到 6 個字元",
    "alphaError": "阿爾法必須在 0 到 100",
    "transparencyError": "圖像數量必須從 0 到 100",
    "redError": "紅色必須在 0 到 255",
    "greenError": "綠色應在 0 到 255 範圍內",
    "blueError": "藍色必須從 0 到 255"
  }
};
});