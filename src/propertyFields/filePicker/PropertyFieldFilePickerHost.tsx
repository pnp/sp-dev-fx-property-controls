...
export default class PropertyFieldFilePickerHost extends React.Component<IPropertyFieldFilePickerHostProps> {
    ...
    return (
      <div>
        ...
        <FilePicker
          ...
          buttonIcon={
            this.props.buttonIcon ? this.props.buttonIcon : 'FileImage'
          }
          ...
          key={this.props.key}
          itemsCountQueryLimit={
            this.props.itemsCountQueryLimit !== undefined
              ? this.props.itemsCountQueryLimit
              : 100
          }
          hideWebSearchTab={
            this.props.hideWebSearchTab !== undefined
              ? this.props.hideWebSearchTab
              : true
          }
          hideRecentTab={
            this.props.hideRecentTab !== undefined
              ? this.props.hideRecentTab
              : false
          }
          hideSiteFilesTab={
            this.props.hideSiteFilesTab !== undefined
              ? this.props.hideSiteFilesTab
              : false
          }
          hideLocalUploadTab={
            this.props.hideLocalUploadTab !== undefined
              ? this.props.hideLocalUploadTab
              : false
          }
          hideLinkUploadTab={
            this.props.hideLinkUploadTab !== undefined
              ? this.props.hideLinkUploadTab
              : false
          }
          hideOneDriveTab={
            this.props.hideOneDriveTab !== undefined
              ? this.props.hideOneDriveTab
              : false
          }
          hideOrganisationalAssetTab={
            this.props.hideOrganisationalAssetTab !== undefined
              ? this.props.hideOrganisationalAssetTab
              : false
          }
          hideStockImages={
            this.props.hideStockImages !== undefined
  ...
  private handleFileChange = async (
    filePickerResult: IFilePickerResult
  ): Promise<void> => {
