define([], () => {
  return {
    ...
    "TermPickerMenuTerm": "Меню за срок",
    ...
    "DeleteSelectedFileButtonLabel": "Изтрий избрания файл",
    ...
    "CloseButton": "Затварям",
    "MonacoEditorOpenButtonLabel": "Отваряне на редактор",
    "MonacoEditorCancelButtonLabel": "Отмени",
    "MonacoEditorSaveButtonLabel": "Спасявам",
    "MonacoEditorPanelTitle": "Редактиране на шаблон",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "Избор на цвят {0} избран.",
      "hex": "Шестнадесетичен",
      "red": "червен",
      "green": "зелен",
      "blue": "син",
      ...
      "alphaAriaLabel": "Алфа",
      "transparencyAriaLabel": "прозрачност",
      "hueAriaLabel": "Любов",
      "svAriaLabel": "Наситеност и яркост",
      "svAriaValueFormat": "Наситеност {0} яркост {1}",
      "svAriaDescription": "Използвайте наляво и надясно клавишите със стрелки, за да регулирате насищане. Използвайте клавишите със стрелки нагоре и надолу, за да регулирате яркостта.",
      "hexError": "Шестнадесетичните стойности трябва да са дълги между 3 и 6 знака",
      "alphaError": "Алфа трябва да бъде между 0 и 100",
      "transparencyError": "Прозрачността трябва да бъде между 0 и 100",
      "redError": "Червеното трябва да е между 0 и 255",
      "greenError": "Зеленото трябва да е между 0 и 255",
      "blueError": "Синьото трябва да е между 0 и 255"
    }
  };
});