define([], () => {
  return {
    ...
    "TermPickerMenuTerm": "Menú para Término",
    ...
    "DeleteSelectedFileButtonLabel": "Eliminar archivo seleccionado",
    ...
    "CloseButton": "Cerrar",
    "MonacoEditorOpenButtonLabel": "Abrir editor",
    "MonacoEditorCancelButtonLabel": "Cancelar",
    "MonacoEditorSaveButtonLabel": "Salvar",
    "MonacoEditorPanelTitle": "Editar plantilla",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} se selecciona un selector de color.",
      "hex": "Sexta edición",
      "red": "rojo",
      "green": "verde",
      "blue": "Llenar",
      ...
      "alphaAriaLabel": "Alfa",
      "transparencyAriaLabel": "Transparencia",
      "hueAriaLabel": "Liubov",
      "svAriaLabel": "Saturación y brillo",
      "svAriaValueFormat": "Saturación {0} brillo del {1}",
      "svAriaDescription": "Utilice los botones de flecha izquierda y derecha para ajustar la saturación. Utilice las flechas hacia arriba y hacia abajo para ajustar el brillo.",
      "hexError": "Los valores hexagonales deben tener entre 3 y 6 caracteres",
      "alphaError": "Alfa debe estar entre 0 y 100",
      "transparencyError": "La diapositiva debe estar entre 0 y 100",
      "redError": "El rojo debe estar entre 0 y 255",
      "greenError": "El verde debe estar entre 0 y 255",
      "blueError": "El azul debe estar entre 0 y 255"
    }
  };
});