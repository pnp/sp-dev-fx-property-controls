define([], () => {
  return {
    ...
    "TermPickerMenuTerm": "Menu cho thời hạn",
    ...
    "DeleteSelectedButtonTitle": "Xóa tệp đã chọn",    
    ...
    "SelectedLabel": "Chọn",
    "SelectIcon": "Biểu tượng Chọn",
    "CloseButton": "Đóng",
    "MonacoEditorOpenButtonLabel": "Mở trình chỉnh sửa",
    "MonacoEditorCancelButtonLabel": "Hủy",
    "MonacoEditorSaveButtonLabel": "Cứu",
    "MonacoEditorPanelTitle": "Chỉnh sửa mẫu",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} bộ phận.",
      "hex": "6f biên tập.",
      "red": "Đỏ",
      "green": "cần tây",
      "blue": "Làm thế nào để hoàn thành",
      "alpha": "Argentina",
      "transparency": "Kaurredzamiba",
      "alphaAriaLabel": "Argentina",
      "transparencyAriaLabel": "Kaurredzamiba",
      "hueAriaLabel": "Argentina",
      "svAriaLabel": "Độ bão hòa và độ sáng",
      "svAriaValueFormat": "Độ sáng {1} {0} độ bão hòa",
      "svAriaDescription": "Sử dụng mũi tên trái và phải để điều chỉnh độ bão hòa. Sử dụng mũi tên lên và xuống để điều chỉnh độ sáng.",
      "hexError": "Giá trị lục giác phải dài từ 3 đến 6 ký tự",
      "alphaError": "alpha phải nằm trong khoảng từ 0 đến 100",
      "transparencyError": "Số lượng hình ảnh phải từ 0 đến 100",
      "redError": "Màu đỏ phải nằm trong khoảng từ 0 đến 255",
      "greenError": "Màu xanh lá cây nên nằm trong khoảng từ 0 đến 255",
      "blueError": "Màu xanh lam phải từ 0 đến 255"
    }
  };
});