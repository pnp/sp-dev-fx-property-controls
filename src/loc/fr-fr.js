define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Modifier les propriétés",
    "EditPropertiesPanelHeaderText": "Modifier les propriétés brutes",
    ...
    "TermPickerMenuTerm": "Menu pour le terme",
    ...
    "DateFormat": "MM/JJ/AAAA hh:mm A",
    "DeleteSelectedFileButtonLabel": "Supprimer le fichier sélectionné",
    ...
    "SiteLinkLabel": "Site",
    "SizeOptionAll": "Tous",
    "SizeOptionExtraLarge": "Très grand",
    ...
    "StockImagesHeader": "Images d’archives",
    "DateTime": {
    ...
    "SelectIcon": "Icône de sélection",
    "CloseButton": "Fermer",
    "MonacoEditorOpenButtonLabel": "Ouvrir l’éditeur",
    "MonacoEditorCancelButtonLabel": "Annuler",
    "MonacoEditorSaveButtonLabel": "Sauvegarder",
    "MonacoEditorPanelTitle": "Modifier le modèle",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} sélecteur de couleurs est sélectionné.",
      "hex": "Sixième édition",
      "red": "rouge",
      "green": "vert",
      "blue": "Remplir",
      ...
      "alphaAriaLabel": "Alfa",
      "transparencyAriaLabel": "Transparence",
      "hueAriaLabel": "Liubov",
      "svAriaLabel": "Saturation et luminosité",
      "svAriaValueFormat": "{1} saturation {0} luminosité",
      "svAriaDescription": "Utilisez les flèches gauche et droite pour régler la saturation. Utilisez les flèches haut et bas pour régler la luminosité.",
      "hexError": "Les valeurs hexagonales doivent comporter entre 3 et 6 caractères",
      "alphaError": "Alpha doit être compris entre 0 et 100",
      "transparencyError": "La diapositive doit être comprise entre 0 et 100",
      "redError": "Le rouge doit être compris entre 0 et 255",
      "greenError": "Le vert doit être compris entre 0 et 255",
      "blueError": "Le bleu doit être compris entre 0 et 255"
    }
  };
});