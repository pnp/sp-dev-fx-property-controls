define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Редактировать свойства",
    "EditPropertiesPanelHeaderText": "Редактировать необработанные свойства",
    ...
    "TermPickerMenuTerm": "Меню на срок",
    ...
    "DeleteSelectedFileButtonLabel": "Удалить выбранный файл",    
    ...
    "ColorPickerStrings": {
      ...
      "alphaAriaLabel": "Альфа",
      "transparencyAriaLabel": "Прозрачность",
      "hueAriaLabel": "Оттенок",
      "svAriaLabel": "Насыщенность и яркость",
      "svAriaValueFormat": "Насыщенность {1} {0} яркость",
      "svAriaDescription": "Используйте стрелки влево и вправо для настройки насыщенности. Чтобы настроить яркость, используйте стрелки вверх и вниз.",
      "hexError": "Шестиугольные значения должны содержать от 3 до 6 символов",
      "alphaError": "альфа должна быть от 0 до 100",
      "transparencyError": "Количество слайдов должно быть от 0 до 100",
      "redError": "Красный должен быть между 0 и 255",
      "greenError": "Зеленый должен быть от 0 до 255",
      "blueError": "Синий должен быть от 0 до 255"
    }
  };
});