define([], () => {
  return {
    ...
    "DeleteSelectedFileButtonLabel": "删除所选文件",    
    ...
    "SelectIcon": "选择图标",
    "CloseButton": "关闭",
    "MonacoEditorOpenButtonLabel": "打开编辑器",
    "MonacoEditorCancelButtonLabel": "取消",
    "MonacoEditorSaveButtonLabel": "救",
    "MonacoEditorPanelTitle": "编辑模板",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0}部门。",
      "hex": "6f 编辑。",
      "red": "红色",
      "green": "芹菜",
      "blue": "如何完成",
      ...
      "hueAriaLabel": "阿根廷",
      "svAriaLabel": "饱和度和亮度",
      "svAriaValueFormat": "亮度{1} {0}饱和度",
      "svAriaDescription": "使用左右箭头来调节饱和度。使用上下箭头调整亮度。",
      "hexError": "六边形值必须长 3 到 6 个字符",
      "alphaError": "阿尔法必须在 0 到 100",
      "transparencyError": "图像数量必须从 0 到 100",
      "redError": "红色必须在 0 到 255",
      "greenError": "绿色应在 0 到 255 范围内",
      "blueError": "蓝色必须从 0 到 255"
    }
  };
});