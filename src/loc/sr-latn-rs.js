define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Izmenite svojstva",
    "EditPropertiesPanelHeaderText": "Izmenite sirova svojstva",
    ...
    "TermPickerMenuTerm": "Meni za pojam",
    ...
    "DeleteSelectedFileButtonLabel": "Izbriši izabrani fajl",    
    ...
    "SelectedLabel": "Izabrali",
    "SelectIcon": "Ikona \"Izaberi\"",
    "CloseButton": "Zatvorite",
    "MonacoEditorOpenButtonLabel": "Otvaranje uređivača",
    "MonacoEditorCancelButtonLabel": "Otkaži",
    "MonacoEditorSaveButtonLabel": "Sačuvaj",
    "MonacoEditorPanelTitle": "Uredi predložak",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} odeljenje.",
      "hex": "6f ed.",
      "red": "crvena",
      "green": "zelena",
      "blue": "Kako završiti",
      "alpha": "Alfa",
      "transparency": "Kaurredzamiba",
      "alphaAriaLabel": "Alfa",
      "transparencyAriaLabel": "Kaurredzamiba",
      "hueAriaLabel": "Liegovas",
      "svAriaLabel": "Zasićenost i svetlina",
      "svAriaValueFormat": "Zasićenost {1} {0} svetlinom",
      "svAriaDescription": "Koristite strelice nalevo i nadesno da biste podesili zasićenost. Koristite strelice nagore i nadole da biste podesili svetlinu.",
      "hexError": "Heksagonalne vrednosti moraju biti dugačke između 3 i 6 znakova",
      "alphaError": "alfa mora biti između 0 i 100",
      "transparencyError": "Broj slajdova bi trebalo da bude od 0 do 100",
      "redError": "Crveno bi trebalo da bude između 0 i 255",
      "greenError": "Zelena bi trebala biti između 0 i 255",
      "blueError": "Plava mora biti između 0 i 255"
    }
  };
});