define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "プロパティを編集する",
    "EditPropertiesPanelHeaderText": "生のプロパティを編集する",
    "SaveButtonLabel": "保存",
    ...
    "DeleteSelectedFileButtonLabel": "選択したファイルを削除",
    ...
    "SelectIcon": "選択アイコン",
    "CloseButton": "閉める",
    "MonacoEditorOpenButtonLabel": "エディターを開く",
    "MonacoEditorCancelButtonLabel": "キャンセル",
    "MonacoEditorSaveButtonLabel": "セーブ",
    "MonacoEditorPanelTitle": "テンプレートの編集",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0}色分解が選択されています。",
      "hex": "第6版",
      "red": "赤い",
      "green": "緑",
      "blue": "塗りつぶすには",
      ...
      "transparency": "透明性",
      "alphaAriaLabel": "アルファ",
      "transparencyAriaLabel": "透明性",
      "hueAriaLabel": "リューボフ",
      "svAriaLabel": "彩度と明るさ",
      "svAriaValueFormat": "{1}彩度{0}明るさ",
      "svAriaDescription": "左右の矢印を使用して彩度を調整します。上矢印と下矢印を使用して明るさを調整します。",
      "hexError": "六角形の値は 3 から 6 文字の間でなければなりません",
      "alphaError": "アルファは 0 から 100 の間でなければなりません",
      "transparencyError": "スライドは 0 から 100 の間でなければなりません",
      "redError": "赤は 0 から 255 の間でなければなりません",
      "greenError": "緑は 0 から 255 の間でなければなりません",
      "blueError": "青は 0 から 255 の間でなければなりません"
    }
  };
});