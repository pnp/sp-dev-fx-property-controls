...
export class CollectionIconField extends React.Component<ICollectionIconFieldProps, ICollectionIconFieldState> {
  ...
  public render(): React.ReactElement<ICollectionIconFieldProps> {
    ...
    return (
      <>
        {renderMode !== 'picker' &&
          <div className={`PropertyFieldTreeCollectionData__panel__icon-field ${styles.iconField}`}>
        ...
        {renderMode === 'picker' &&
          <div className={`PropertyFieldTreeCollectionData__panel__icon-field ${styles.collectionDataField} ${styles.iconPicker}`}>
            <ActionButton 
              required={field.required}
              disabled={this.props.disableEdit} 
