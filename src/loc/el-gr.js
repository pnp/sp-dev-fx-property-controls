define([], () => {
  return {
    ...
    "EditPropertiesButtonLabel": "Επεξεργασία ιδιοτήτων",
    "EditPropertiesPanelHeaderText": "Επεξεργασία ακατέργαστων ιδιοτήτων",
    ...
    "TermPickerMenuTerm": "Μενού για τον όρο",
    ...
    "DateFormat": "ΜΜ/ΗΗ/ΕΕΕΕ ωω",
    "DeleteSelectedFileButtonLabel": "Διαγραφή επιλεγμένου αρχείου",
    ...
    "SelectIcon": "Εικονίδιο επιλογής",
    "CloseButton": "Κλείνω",
    "MonacoEditorOpenButtonLabel": "Ανοίξτε το πρόγραμμα επεξεργασίας",
    "MonacoEditorCancelButtonLabel": "Ακυρώνω",
    "MonacoEditorSaveButtonLabel": "Σώζω",
    "MonacoEditorPanelTitle": "Επεξεργασία προτύπου",
    "ColorPickerStrings": {
      "rootAriaLabelFormat": "{0} επιλεγεί ένας επιλογέας χρώματος.",
      "hex": "Έκτη έκδοση",
      "red": "κόκκινος",
      "green": "πράσινος",
      "blue": "Συμπληρώνω",
      ...
      "alphaAriaLabel": "Άλφα",
      "transparencyAriaLabel": "Διαφάνεια",
      "hueAriaLabel": "Λιούμποφ",
      "svAriaLabel": "Κορεσμός και φωτεινότητα",
      "svAriaValueFormat": "Ο κορεσμός {0} η φωτεινότητα του {1}",
      "svAriaDescription": "Χρησιμοποιήστε τα κουμπιά αριστερού και δεξιού βέλους για να ρυθμίσετε τον κορεσμό. Χρησιμοποιήστε το επάνω και το κάτω βέλος για να ρυθμίσετε τη φωτεινότητα.",
      "hexError": "Οι εξαγωνικές τιμές πρέπει να αποτελούνται από 3 έως 6 χαρακτήρες",
      "alphaError": "Το Alpha πρέπει να είναι μεταξύ 0 και 100",
      "transparencyError": "Η διαφάνεια πρέπει να είναι μεταξύ 0 και 100",
      "redError": "Το κόκκινο πρέπει να είναι μεταξύ 0 και 255",
      "greenError": "Το πράσινο πρέπει να είναι μεταξύ 0 και 255",
      "blueError": "Το μπλε πρέπει να είναι μεταξύ 0 και 255"
    }
  };
});