...
export default class PropertyFieldDropdownHost extends React.Component<
  IPropertyFieldDropdownWithCalloutHostProps,
  null
> {
  ...
  public render(): JSX.Element {
    ...
    dropdownProps.options = this._convertPropPaneOptionsToDropdownOptions(
  ...
  private _convertPropPaneOptionsToDropdownOptions(
    propPaneOptions: IPropertyPaneDropdownOption[]
  ): IDropdownOption[] {
